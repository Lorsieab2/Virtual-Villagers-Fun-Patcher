"""Execute the emitted VV4 trampoline with accepted and rejected game calls."""
...
class Vv4RejectedConceptionDoesNotLog(unittest.TestCase):
    def setUp(self):
        manifest = json.loads((ROOT / "data" / "vv4_parentage_feature.json").read_text())
