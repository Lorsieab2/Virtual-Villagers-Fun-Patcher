...
class ContractTests(unittest.TestCase):
    ...
    def test_wrong_static_hook_rejected(self): self.check_bad(lambda d:d["replacement"].update(serializer_hook_target="0x1234"))
    def test_wrong_static_candidate_hash_rejected(self): self.check_bad(lambda d:d["replacement"].update(candidate_sha256="00"*32))
