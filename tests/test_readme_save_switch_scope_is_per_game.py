...
SLOT_PATH_WINDOWS = {
    ...
    # 0xB25AB..0xB25B9; VV4 delivers at 0xCCB25/0xCCB69, nowhere near its slot
    # cave (0xCCFD0) or its out-of-line reset helper (0xCCE00).
    #
    # VV2's window moved when its mask sweep was relocated past the parentage
    # feature's cave: that page is shared, the parentage overlay owns .vvmk
    # 0x41A..0x4D8, and laying the mask stubs out sequentially walked into it
    # once the village-tag check was added. The slot stub now follows the
    # sweep. The window is measured from the rendered image by following the
    # 0x403160 detour, exactly as test_queued_events_clear_on_slot_change does.
    "vv1": [(0x8E800, 0x8E900)],
    "vv2": [(0xB2560, 0xB2600)],
    "vv3": [(0xCB100, 0xCB180)],
