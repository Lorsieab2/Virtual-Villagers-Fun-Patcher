...
- Collection Progression render SHA-256: `685E468C595125BF3D5C195E77ECCDE5CC86064BF16B8A4575797408E1FE6BB0`
- Immediate Fixed render SHA-256: `8EBD1A76A642468B411D8A4750C268098E007808783F74B4AE75AF12120FA428`
...
Each Tech and Detail modal call is wrapped by one guarded native-state transition. The compact entries at VA 0x7B2B40 and 0x7B2B47 select the menu target and share VA 0x7B2B4C. The wrapper resolves only SDL_GetWindowFlags through the existing GetModuleHandleA/GetProcAddress IATs, validates flags 0 or 0x1001 against the native engine state, calls the proven native leave (0x40A270) and enter (0x40A280) transitions through the 0x4080C0 singleton chain, and fail-closes on identity, dependency, or restore failure. It remains disabled/catalog-hidden pending independent emitted-byte recertification.
The candidate-owned DLL transform removes the five-item legacy Cure row from dialogs 201 and 203 while preserving dialog 202 and all non-resource bytes.
