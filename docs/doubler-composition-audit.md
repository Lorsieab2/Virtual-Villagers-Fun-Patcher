...
Food Mastery affecting food-point gain is code-confirmed for VV4 only, while
VV1 and VV3 are code-confirmed absent in their exact-build evidence. VV2 and
VV5 remain unverified; no presence or absence is inferred from another game's
implementation or from player reports. VV4's native transform is documented in
its evidence row above.
