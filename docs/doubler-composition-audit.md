...
Food Mastery affecting food-point gain is code-confirmed for VV4 only in the
current evidence set. VV1, VV2, VV3, and VV5 remain unverified; no presence or
absence is inferred from another game's implementation or from player reports.
Those four games therefore remain pending their own exact-build Food Mastery
audit, while VV4's native transform is documented in its evidence row above.
