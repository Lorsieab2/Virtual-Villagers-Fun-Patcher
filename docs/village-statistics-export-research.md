...
binaries. The Tree of Life carries `lea ecx, [esi+1C34h]` in its own callers,
which is the positive evidence that the offsets are its own rather than
transcribed. Both are hooked, because a death by cumulative damage reaches zero
