...
- Mode-specific guarded edits: experimental_expanded_256=7, experimental_expanded_256_progression=7, collection_progression=6, immediate_fixed=6; these rows are selected only for the named population mode.
