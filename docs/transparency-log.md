...
VV4 Full Mastery UI Playtest 2 is HARD WITHDRAWN and catalog-hidden after repeating the startup access violation 0xC0000005 at RVA 0x21570 / VA 0x421570 (`8B4108`). The preserved candidate passed malformed arguments to sub_401C20: Tech decoded as event=4, asset=0x48, x=0x489F37, y=3, parent=1, flags=13; Detail was identical except flags=2. Historical D13 static approval is revoked. The base and feature are disabled, Cure calls/payload containment is unchanged, unrelated features are unchanged, and Expanded-256 remains ON HOLD/fail-closed.
