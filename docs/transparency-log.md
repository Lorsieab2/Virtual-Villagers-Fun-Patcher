...
Enables the Origins Tech-screen Upgrades button/menu and the latest village-wide upgrades: Running, Full Mastery, and Set Age to 18. Processes active living villagers only and uses the game's native handlers where implemented. Runtime/player confirmation pending.
...
Enables the Origins Tech-screen Upgrades button/menu and the latest village-wide upgrades: Running, Full Mastery, and Set Age to 18. Processes active living Believers only; masked Heathens, including the sick-Heathen puzzle record, are skipped before action-specific reads or writes. Runtime/player confirmation pending.
