...
**Requires no other patch to be ticked. Needed by Enable Origins Tech, Details, and Village-Wide Upgrades: unticking this unticks it. Needed by Write Births and Conceptions Log to Text File: unticking this unticks it.**
...
#### Write Births and Conceptions Log to Text File (`vv2_write_parentage_log`)
...
#### Write Births and Conceptions Log to Text File (`vv5_write_parentage_log`)
