...
The current VV4 public catalog exposes Origins and the separately certified all-villager Full Mastery record. Individual Full Mastery remains STOP because its command lacks the complete native exact-100 transaction. Full Heal, Running, and the legacy atomic village-wide record remain disabled/hidden; retained crash and repair evidence does not publish them. Expanded-256 remains ON HOLD.

The former VV5 Full Mastery package commit `5e52be5e41b25b0f541c3c762e8caacc2dbd150b` was HARD WITHDRAWN after an immediate startup auto-close. The disabled geometry evidence records native cached `Images\btn_trophies.png` resource `0x6A` (96x39) at local `(137,2)`. Full Mastery and Running remain disabled/hidden. The Tech/Detail click route remains STOP pending an exact `sub_44B560` guard and click-to-dialog player receipt.
...
VV3 Full Heal / Cure All is absent from the public catalog because its selected-villager Running dependency is disabled and hidden. Retained implementation and static evidence do not authorize GUI, CLI, Select All, or runtime publication.
