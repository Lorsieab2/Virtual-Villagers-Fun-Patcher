...
VV5's independent command-7-only Full Mastery implementation is certified
under disassembly commit `8193629` and available for runtime playtesting. It
uses the native six-skill writer for active living current believers only;
Heathens and commands 6/8 remain excluded.
