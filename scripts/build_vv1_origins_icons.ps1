...
$nativeRoot = Join-Path $projectRoot "native\vv1_origins_icons"
...
& (Join-Path $sdkRoot "bin\$sdkVersion\x86\rc.exe") `
    /nologo `
    /fo (Join-Path $outputRoot "vv1_origins_icons.res") `
    (Join-Path $nativeRoot "vv1_origins_icons.rc")
...
@(
    (Join-Path $outputRoot "vv1_origins_icons.res"),
    (Join-Path $projectRoot "vv1_origins_icons.obj"),
    (Join-Path $projectRoot "vv1_origins_icons.exp"),
    (Join-Path $projectRoot "vv1_origins_icons.lib")
