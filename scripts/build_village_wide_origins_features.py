...
def main() -> None:
    ...
    for game_id, config in CONFIG.items():
        ...
        description = (
            ...
            "exclusive upgrades: All Villagers Like Running, All Villagers are "
            "Jack-Of-All-Trades, and All Villagers are 18. Each costs exactly 1,000,000 "
        ...
        feature = {
            ...
            "extension_abi": {
                ...
                "commands": {
                    ...
                    "7": "All Villagers are Jack-Of-All-Trades",
            ...
            "behavior_changes": [
                ...
                "Jack-Of-All-Trades writes the native five- or six-skill mastery fields for eligible living villagers.",
