...
CONCEPTION_TOTAL_VA = 0x004D6DE8
...
BIRTH_SITES = (
    (0x00468858, bytes.fromhex("8bf883ffff"), "the first child of every birth"),
    (0x004688F3, bytes.fromhex("8be883fdff"), "the twin"),
    (0x00468996, bytes.fromhex("8bf869c03c2e0000"), "the triplet"),
)
...
BIRTH_RECORD_BASE = 0x44
BIRTH_STRIDE = 0x2E3C
BIRTH_RECORDS_VA = 0x0050E568
